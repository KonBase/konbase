    ...
    switch (error) {
      ...
      case 'OAuthSignin':
        return {
          ...
          message:
            'There was an error with the OAuth provider. Please try again or use email/password.',
          icon: <AlertTriangle size={48} color='#f44336' />,
        };
      case 'OAuthCallback':
        return {
      ...
      case 'OAuthCreateAccount':
        return {
          ...
          message:
            'Could not create account with OAuth provider. Please try again or use email/password.',
          icon: <AlertTriangle size={48} color='#f44336' />,
        };
      ...
      case 'Callback':
        return {
          ...
          message:
            'There was an error with the authentication callback. Please try again.',
          icon: <AlertTriangle size={48} color='#f44336' />,
        };
    ...
    <Container maxWidth='sm' sx={{ py: 6 }}>
      ...
      <Card elevation={2}>
        <CardContent sx={{ p: 4, textAlign: 'center' }}>
          <Box sx={{ mb: 3 }}>{errorInfo.icon}</Box>
      ...
      <Card sx={{ mt: 4 }}>
        <CardContent>
          ...
          <Box component='ul' sx={{ pl: 2, m: 0 }}>
            ...
            <Typography component='li' variant='body2' color='text.secondary'>
              Check if you have any browser extensions blocking the
              authentication
            </Typography>
            <Typography component='li' variant='body2' color='text.secondary'>
