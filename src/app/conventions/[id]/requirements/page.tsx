...
interface ConventionRequirementsPageProps {
  params: Promise<{ id: string }>;
}

export default function ConventionRequirementsPage({
  params,
}: ConventionRequirementsPageProps) {
  const { id: conventionId } = use(params);
    ...
    switch (status.toLowerCase()) {
      case 'requested':
        return (
          ...
          >
            <Hourglass className="mr-1 h-3 w-3" /> Requested
          </Badge>
        );
      case 'approved':
        return (
      ...
      case 'fulfilled':
        return (
          <Badge variant="default" className="bg-green-600 hover:bg-green-700">
            <CheckCircleIcon className="mr-1 h-3 w-3" /> Fulfilled
          </Badge>
        );
      default:
      ...
      <div className="space-y-6 p-4 md:p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b">
          <div>
            ...
            <p className="text-muted-foreground">
              Track tasks, equipment, and resource needs for this convention.
            </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              List of all requirements for this convention.
            </CardDescription>
                      ...
                      <TableRow key={requirement.id}>
                        ...
                        <TableCell className="text-sm text-muted-foreground">
                          <div className="flex items-center gap-1">
                            ...
                            {requirement.requestor?.display_name ||
                              requirement.requestor?.email ||
                              'Unknown'}
                          </div>
                        </TableCell>
                        <TableCell className="text-sm text-muted-foreground">
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <div className="flex items-center gap-1">
                                ...
                                <span>
                                  {formatDistanceToNow(
                                    new Date(requirement.requested_at),
                                    { addSuffix: true },
                                  )}
                                </span>
                              </div>
