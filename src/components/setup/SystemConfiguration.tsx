...
import { Settings, Mail, Shield, Globe } from 'lucide-react';
...
export const SystemConfiguration: React.FC<SystemConfigurationProps> = ({
  ...
  const [config, setConfig] = useState({
    ...
    smtpUser: '',
    smtpPassword: '',
    fromEmail: (setupData.adminUser as { email?: string })?.email || '',
    fromName: 'KonBase',
    ...
    try {
      const response = await fetch('/api/setup/configure-system', {
        ...
        body: JSON.stringify({
          ...
          associationId: (setupData.association as { id: string }).id,
        }),
      });
  ...
  return (
    <Box>
      ...
      <Typography color='text.secondary' sx={{ mb: 3 }}>
        Configure basic system settings and features for your KonBase
        installation.
      </Typography>
        ...
        <Card>
          <CardContent>
            ...
            <TextField
              ...
              onChange={e =>
                handleConfigChange('siteDescription', e.target.value)
              }
              sx={{ mb: 2 }}
            />
        ...
        <Card>
          <CardContent>
            ...
            <TextField
              ...
              onChange={e =>
                handleConfigChange('maxLoginAttempts', parseInt(e.target.value))
              }
              sx={{ mb: 2 }}
            />
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={e =>
                    handleConfigChange('twoFactorRequired', e.target.checked)
                  }
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={e =>
                    handleConfigChange('enableAuditLogs', e.target.checked)
                  }
                />
              }
              label='Audit Logs'
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={e =>
                    handleConfigChange('enableChat', e.target.checked)
                  }
                />
              }
              label='Chat System'
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={e =>
                    handleConfigChange('enableFileUploads', e.target.checked)
                  }
                />
              }
              label='File Uploads'
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={e =>
                    handleConfigChange('enableAnalytics', e.target.checked)
                  }
                />
              }
              label='Analytics'
      ...
      <Alert severity='info' sx={{ mt: 3, mb: 3 }}>
        <Typography variant='body2'>
          <strong>Note:</strong> You can modify these settings later from the
          admin panel. Some features like email notifications require proper
      ...
      <Box display='flex' justifyContent='space-between'>
        ...
        <Button
          ...
          disabled={loading}
          startIcon={
            loading ? <CircularProgress size={16} /> : <Settings size={16} />
          }
        >
          Configure System
        </Button>
