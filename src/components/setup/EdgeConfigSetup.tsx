...
export const EdgeConfigSetup: React.FC<EdgeConfigSetupProps> = ({
  onStatusChange,
}) => {
    ...
    <Card>
      <CardContent>
        ...
        <Typography variant='body2' color='text.secondary' mb={3}>
          Edge Config provides ultra-low latency data access (&lt; 15ms) for
          configuration data, feature flags, and small datasets. Perfect for
          KonBase's configuration needs.
        </Typography>
        ...
        {status && (
          <Alert
            severity={
              getStatusColor() as 'error' | 'warning' | 'info' | 'success'
            }
            sx={{ mb: 3 }}
          >
        ...
        <Box mt={3} p={2} bgcolor='grey.50' borderRadius={1}>
          <Typography variant='caption' color='text.secondary'>
            <strong>Benefits of Edge Config:</strong>
            <br />
            • Ultra-low latency (&lt; 15ms at P99)
            <br />
            ...
            <br />• Built-in caching and optimization
          </Typography>
        </Box>
      </CardContent>
    </Card>
