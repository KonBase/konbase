...
export const BlobStorageSetup: React.FC<BlobStorageSetupProps> = ({ onStatusChange }) => {
  ...
  const getStatusIcon = () => {
    ...
    if (status.success && status.configured) return <CheckCircle className="w-5 h-5 text-green-500" />;
    if (status.configured) return <AlertTriangle className="w-5 h-5 text-yellow-500" />;
      ...
      <Card variant="outlined" sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Button
            ...
            disabled={loading}
            startIcon={loading ? <CircularProgress size={16} /> : <Settings className="w-4 h-4" />}
          >
        ...
        <CardContent>
          ...
          <Box mb={3}>
            ...
            <Typography variant="body2" color="text.secondary" mb={2}>
              Global edge storage with &lt; 15ms latency. Perfect for production applications.
            </Typography>
            ...
            <Box mb={2}>
              ...
              <Box component="ol" pl={2}>
                ...
                <Typography component="li" variant="body2" color="text.secondary">
                  Set the <code>BLOB_READ_WRITE_TOKEN</code> environment variable
                </Typography>
              </Box>
            </Box>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" mb={2}>
              Files stored locally in the <code>/uploads</code> directory. Good for development and testing.
            </Typography>

            <Alert severity="warning">
              <Typography variant="body2">
                Local storage is not recommended for production deployments as files may be lost during deployments.
              </Typography>
            </Alert>
          </Box>
        </CardContent>
