...
export const DatabaseSetup: React.FC<DatabaseSetupProps> = ({
  ...
  const handleNext = () => {
    if (testResult === 'success') {
      onNext({ connectionString });
    } else {
      onError('Please test and verify database connection before proceeding');
    }
  };
  ...
  return (
    <Box>
      ...
      <Typography color="text.secondary" sx={{ mb: 3 }}>
        Configure your PostgreSQL database connection. KonBase requires a PostgreSQL database to store all data.
      </Typography>
