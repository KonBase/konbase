  ...
  const handleAddDocument = async () => {
    ...
    try {
      ...
      if (error.message.includes('insert') && filePath) {
        console.warn(
          'Database insert failed after storage upload. Attempting to remove orphaned file:',
          filePath,
        );
    ...
    try {
      ...
      if (storageError) {
        ...
        toast({
          title: 'Warning',
          description:
            'Document record deleted, but failed to remove file from storage.',
          ...
          {documents.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Upload documents, manuals, or warranty information for your
                inventory items.
              </p>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Upload a document, manual, warranty, or other file related to an
              inventory item.
            </DialogDescription>
          </DialogHeader>
