...
import { getBrandingConfig, getBrandingAssets, generateBrandingCSS } from '@/lib/branding';
...
export function BrandingHead() {
  useEffect(() => {
    ...
    const appleWebAppTitle = document.querySelector('meta[name="apple-mobile-web-app-title"]') as HTMLMetaElement;
    if (appleWebAppTitle) {
      appleWebAppTitle.content = branding.appName;
    }
    
    // Update application name
    const applicationName = document.querySelector('meta[name="application-name"]') as HTMLMetaElement;
    if (applicationName) {
