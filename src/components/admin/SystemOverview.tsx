...
export const SystemOverview: React.FC = () => {
  ...
  const recentActivity = [
    { action: 'New user registered', user: 'john.doe@example.com', time: '2 minutes ago', type: 'info' },
    { action: 'Association created', user: 'admin@konbase.com', time: '5 minutes ago', type: 'success' },
    { action: 'Failed login attempt', user: 'unknown@example.com', time: '8 minutes ago', type: 'warning' },
    { action: 'System backup completed', user: 'system', time: '1 hour ago', type: 'info' },
    { action: 'Database maintenance', user: 'system', time: '2 hours ago', type: 'info' },
  ];
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      default: return <Clock size={16} color="#2196f3" />;
    }
  };
            ...
            <CardContent>
              ...
              <Box mb={2}>
                <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                  ...
                  <Typography variant="body2">{systemHealth.cpuUsage}%</Typography>
                </Box>
                <LinearProgress
                  variant="determinate"
              ...
              <Box mb={2}>
                <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                  ...
                  <Typography variant="body2">{systemHealth.memoryUsage}%</Typography>
                </Box>
                <LinearProgress
                  variant="determinate"
              ...
              <Box>
                <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                  ...
                  <Typography variant="body2">{systemHealth.diskUsage}%</Typography>
                </Box>
                <LinearProgress
                  variant="determinate"
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={performanceData}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Line type="monotone" dataKey="users" stroke="#8884d8" strokeWidth={2} name="Active Users" />
                  <Line type="monotone" dataKey="requests" stroke="#82ca9d" strokeWidth={2} name="API Requests" />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
