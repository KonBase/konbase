              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={e =>
                      handleSettingChange('enableAuditLogs', e.target.checked)
                    }
                  />
                }
                label='Audit Logs'
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={e =>
                      handleSettingChange('enableFileUploads', e.target.checked)
                    }
                  />
                }
                label='File Uploads'
        ...
        <Card>
          <CardContent>
            ...
            <Alert severity='warning' sx={{ mb: 2 }}>
              Environment variables are sensitive and should be managed
              carefully. Changes may require application restart.
            </Alert>

            <List>
              {envVariables?.map(
                (env: { key: string; value: string }, index: number) => (
